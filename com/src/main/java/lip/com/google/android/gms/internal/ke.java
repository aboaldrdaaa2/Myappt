...
public interface ke extends IInterface {
    ...
    public static abstract class a extends Binder implements ke {
        ...
        private static class a implements ke {
            private IBinder kq;
            ...
            public void a(kd kdVar, Uri uri, Bundle bundle, boolean z) throws RemoteException {
        ...
        public static ke bi(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ke)) ? new a(iBinder) : (ke) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    a(com.google.android.gms.internal.kd.a.bh(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void a(kd kdVar, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
