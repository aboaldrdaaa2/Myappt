...
public interface df extends IInterface {
    ...
    public static abstract class a extends Binder implements df {
        ...
        private static class a implements df {
            private IBinder kq;
        ...
        public static df t(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof df)) ? new a(iBinder) : (df) queryLocalInterface;
        }
