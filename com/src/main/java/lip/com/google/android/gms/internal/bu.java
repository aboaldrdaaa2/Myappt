...
public interface bu extends IInterface {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    a(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? al.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? ai.CREATOR.createFromParcel(data) : null, data.readString(), com.google.android.gms.internal.bv.a.k(data.readStrongBinder()));
                ...
                case 3:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    view = com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        aiVar = ai.CREATOR.createFromParcel(data);
                    }
                    a(view, aiVar, data.readString(), com.google.android.gms.internal.bv.a.k(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                ...
                case 6:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    a(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? al.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? ai.CREATOR.createFromParcel(data) : null, data.readString(), data.readString(), com.google.android.gms.internal.bv.a.k(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    a(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? ai.CREATOR.createFromParcel(data) : null, data.readString(), data.readString(), com.google.android.gms.internal.bv.a.k(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
    ...
    void a(d dVar, ai aiVar, String str, bv bvVar) throws RemoteException;

    void a(d dVar, ai aiVar, String str, String str2, bv bvVar) throws RemoteException;

    void a(d dVar, al alVar, ai aiVar, String str, bv bvVar) throws RemoteException;

    void a(d dVar, al alVar, ai aiVar, String str, String str2, bv bvVar) throws RemoteException;
