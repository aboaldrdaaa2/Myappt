    ...
    public static abstract class a extends Binder implements IStreetViewPanoramaFragmentDelegate {
        ...
        private static class a implements IStreetViewPanoramaFragmentDelegate {
            ...
            public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
                ...
                try {
                    ...
                    IStreetViewPanoramaDelegate aT = com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate.a.aT(obtain2.readStrongBinder());
                    return aT;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
