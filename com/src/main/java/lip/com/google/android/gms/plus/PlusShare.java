package lip.com.google.android.gms.plus;
...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            hm.a(plusClient != null, "PlusClient must not be null.");
            hm.a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            hm.a(plusClient.jS().by(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            ...
            hm.b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                hm.a(PlusShare.bv(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Builder addStream(Uri streamUri) {
            ...
            this.abI.add(uri);
            this.abI.add(streamUri);
            return this;
        }

        public Intent getIntent() {
            boolean z = true;
            boolean z2 = this.abI != null && this.abI.size() > 1;
            ...
            hm.a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            hm.a(z3, "The content URL is required for interactive posts.");
            ...
            hm.a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                hm.a(PlusShare.bv(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            hm.b(this.abH, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            hm.b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
    ...
    public static Person createPerson(String id, String displayName) {
        if (TextUtils.isEmpty(id)) {
            ...
            return new ks(displayName, id, null, 0, null);
        } else {
