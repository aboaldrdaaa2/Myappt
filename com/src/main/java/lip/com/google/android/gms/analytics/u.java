...
class u {
    ...
    private SortedSet<a> uS = new TreeSet();
    ...
    public synchronized void a(a aVar) {
        if (!this.uU) {
            this.uS.add(aVar);
            this.uT.append("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(aVar.ordinal()));
        }
    }
