...
public interface lk extends IInterface {
    ...
    public static abstract class a extends Binder implements lk {

        private static class a implements lk {
            private IBinder kq;
        ...
        public static lk bo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof lk)) ? new a(iBinder) : (lk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    a(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? (WalletFragmentOptions) WalletFragmentOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                ...
                case 3:
                    data.enforceInterface("com.google.android.gms.wallet.fragment.internal.IWalletFragmentDelegate");
                    d onCreateView = onCreateView(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
