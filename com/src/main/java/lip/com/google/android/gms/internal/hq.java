...
public class hq<K, V> {
    ...
    L_0x000a:
        monitor-enter(r4);
        r0 = r4.GM;	 Catch:{ all -> 0x002a }
        r0 = r0.get(r5);	 Catch:{ all -> 0x002a }
        if (r0 == 0) goto L_0x001b;
    L_0x0013:
        r1 = r4.GR;	 Catch:{ all -> 0x002a }
        r1 = r1 + 1;
        r4.GR = r1;	 Catch:{ all -> 0x002a }
        monitor-exit(r4);	 Catch:{ all -> 0x002a }
    L_0x001a:
        return r0;
    L_0x001b:
        r0 = r4.GS;	 Catch:{ all -> 0x002a }
        r0 = r0 + 1;
        r4.GS = r0;	 Catch:{ all -> 0x002a }
        monitor-exit(r4);	 Catch:{ all -> 0x002a }
        r1 = r4.create(r5);
    ...
    L_0x002d:
        monitor-enter(r4);
        r0 = r4.GP;	 Catch:{ all -> 0x0053 }
        r0 = r0 + 1;
        r4.GP = r0;	 Catch:{ all -> 0x0053 }
        r0 = r4.GM;	 Catch:{ all -> 0x0053 }
        r0 = r0.put(r5, r1);	 Catch:{ all -> 0x0053 }
        if (r0 == 0) goto L_0x0049;
    L_0x003c:
        r2 = r4.GM;	 Catch:{ all -> 0x0053 }
    ...
    L_0x0056:
        ...
        goto L_0x001a;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.hq.get(java.lang.Object):V");
    }
    ...
    public final synchronized String toString() {
        ...
        int i = 0;
        synchronized (this) {
            int i2 = this.GR + this.GS;
            if (i2 != 0) {
                i = (this.GR * 100) / i2;
            }
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.GN), Integer.valueOf(this.GR), Integer.valueOf(this.GS), Integer.valueOf(i)});
        }
        return format;
    }
    ...
    L_0x0043:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.hq.trimToSize(int):void");
    }
}
