...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        private static class a implements b {
            ...
            public void a(int i, Bundle bundle, ie ieVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusCallbacks");
            ...
            public void a(int i, ks ksVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.plus.internal.IPlusCallbacks");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    if (data.readInt() != 0) {
                        L = ie.CREATOR.createFromParcel(data);
                    }
                    a(readInt, bundle, L);
                    reply.writeNoException();
                    return true;
                case 6:
                    ...
                    a(x, data.readString(), data.readString());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                    h(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
                ...
                case 9:
                    ...
                    if (data.readInt() != 0) {
                        bG = ks.CREATOR.createFromParcel(data);
                    }
                    a(readInt2, bG);
                    reply.writeNoException();
                    return true;
    ...
    void a(int i, Bundle bundle, ie ieVar) throws RemoteException;

    void a(int i, ks ksVar) throws RemoteException;
