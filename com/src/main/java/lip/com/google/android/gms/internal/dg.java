...
public interface dg extends IInterface {
    ...
    public static abstract class a extends Binder implements dg {
        ...
        private static class a implements dg {
            private IBinder kq;
        ...
        public static dg u(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof dg)) ? new a(iBinder) : (dg) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
                    a(com.google.android.gms.internal.df.a.t(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void a(df dfVar) throws RemoteException;
