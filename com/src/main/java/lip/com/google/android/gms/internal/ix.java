...
public interface ix extends IInterface {
    ...
    public static abstract class a extends Binder implements ix {

        private static class a implements ix {
            private IBinder kq;
        ...
        public static ix ao(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ix)) ? new a(iBinder) : (ix) queryLocalInterface;
        }
