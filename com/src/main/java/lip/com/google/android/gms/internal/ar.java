        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder a = a(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()), data.readInt() != 0 ? al.CREATOR.createFromParcel(data) : null, data.readString(), com.google.android.gms.internal.bt.a.i(data.readStrongBinder()), data.readInt());
