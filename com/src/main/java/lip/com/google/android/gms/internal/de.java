...
public interface de extends IInterface {
    ...
    public static abstract class a extends Binder implements de {
        ...
        public static de s(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof de)) ? new a(iBinder) : (de) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder b = b(com.google.android.gms.dynamic.d.a.ag(data.readStrongBinder()));
