...
class MRaid {
    ...
    private static final String ORIGINAL_MMJS_URL = "http://cdn.millennialmedia.com/mmjs/v1.7/mm.js";
    ...
    static WeakReference<Finished> finishedRef;
    ...
    static String injectMraidJs(Context context, String content) {
        ...
        MMLog.d(TAG, "Mraid path: " + getMRaidJsPath(context));
        if (matcher.find()) {
    ...
    static void downloadMraidJs(final Context context, final String url) {
        if (!TextUtils.isEmpty(url)) {
            ThreadUtils.execute(new Runnable() {
                public void run() {
                    Finished fin;
                    try {
                        MMLog.w(MRaid.TAG, "MMJS -  download start (" + url + ")");
                        HttpResponse response = new DefaultHttpClient().execute(new HttpGet(url));
                        MMLog.w(MRaid.TAG, "MMJS -  download finish (" + url + ")");
                        if (MRaid.saveMRaid(context, response.getEntity().getContent()) && MRaid.storeMraidUrl(context, url)) {
                            MMLog.w(MRaid.TAG, "MMJS -  download saved (" + url + ")");
                        }
                        if (MRaid.finishedRef != null) {
                            fin = (Finished) MRaid.finishedRef.get();
                            if (fin == null) {
                                return;
                            }
                            fin.finished();
                        ...
                        MMLog.e(MRaid.TAG, "Mraid download exception: ", e);
                        if (MRaid.finishedRef != null) {
                            fin = (Finished) MRaid.finishedRef.get();
                            if (fin == null) {
                            }
                        ...
                        MMLog.e(MRaid.TAG, "Mraid download exception: ", e2);
                        if (MRaid.finishedRef != null) {
                            fin = (Finished) MRaid.finishedRef.get();
                            if (fin == null) {
                            }
                        ...
                        MMLog.e(MRaid.TAG, "Mraid download exception: ", e3);
                        if (MRaid.finishedRef != null) {
                            fin = (Finished) MRaid.finishedRef.get();
                            if (fin == null) {
                            }
    ...
    private static File getMRaidJsFile(Context context) {
        return new File(AdCache.getInternalCacheDirectory(context), MRAID_JS_FILE_NAME);
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:49:0x0127 A:{Catch:{ Exception -> 0x012c }} */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0074  */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x0146  */
    /* JADX WARNING: Removed duplicated region for block: B:54:0x013d A:{SYNTHETIC, Splitter: B:54:0x013d} */
    /* JADX WARNING: Removed duplicated region for block: B:57:0x0142 A:{Catch:{ Exception -> 0x017a }} */
    static String getMMJSStats(Context r22) {
        /*
        r17 = hasMraidLocally(r22);
        if (r17 != 0) goto L_0x0009;
    L_0x0006:
        r17 = "No MMJS Downloaded!";
    L_0x0008:
        return r17;
    L_0x0009:
        r13 = getMRaidJsFile(r22);
        r14 = 0;
        r6 = 0;
        r12 = "";
        r2 = "";
        r16 = "";
        r7 = new java.io.FileInputStream;	 Catch:{ Exception -> 0x0113 }
        r7.<init>(r13);	 Catch:{ Exception -> 0x0113 }
        r17 = r13.length();	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r0 = r17;
        r0 = (int) r0;	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r17 = r0;
        r0 = r17;
        r3 = new byte[r0];	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r7.read(r3);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r17 = "MD5";
        r11 = java.security.MessageDigest.getInstance(r17);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r8 = r11.digest(r3);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r12 = com.millennialmedia.android.MMSDK.byteArrayToString(r8);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r13 = getMRaidJsFile(r22);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r15 = new java.io.BufferedReader;	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r17 = new java.io.FileReader;	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r0 = r17;
        r0.<init>(r13);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r0 = r17;
        r15.<init>(r0);	 Catch:{ Exception -> 0x019c, all -> 0x0195 }
        r9 = 0;
    L_0x004b:
        r17 = 10;
        r0 = r17;
    ...
    L_0x0051:
        r10 = r15.readLine();	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        if (r10 != 0) goto L_0x00a4;
    L_0x0057:
        if (r7 == 0) goto L_0x005c;
    L_0x0059:
        r7.close();	 Catch:{ Exception -> 0x0187 }
    L_0x005c:
        if (r15 == 0) goto L_0x0061;
    L_0x005e:
        r15.close();	 Catch:{ Exception -> 0x0187 }
    L_0x0061:
        r6 = r7;
        r14 = r15;
    L_0x0063:
        r4 = new java.util.Date;
        r17 = r13.lastModified();
        r0 = r17;
        r4.<init>(r0);
        r17 = android.text.TextUtils.isEmpty(r16);
        if (r17 == 0) goto L_0x0146;
    L_0x0074:
        r17 = "MMJS Stats: buildDate[%s] MD5[%s] dlDate[%s] Size[%d] Url[%s]";
        r18 = 5;
        r0 = r18;
        ...
        r18[r19] = r20;
        r19 = 4;
        r20 = getPreviousUrl(r22);
        r18[r19] = r20;
        r17 = java.lang.String.format(r17, r18);
        goto L_0x0008;
    L_0x00a4:
        r17 = android.text.TextUtils.isEmpty(r10);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        if (r17 != 0) goto L_0x010f;
    L_0x00aa:
        r17 = "* Built";
        r0 = r17;
        r17 = r10.contains(r0);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        if (r17 == 0) goto L_0x00d5;
    L_0x00b4:
        r17 = android.text.TextUtils.isEmpty(r2);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        if (r17 == 0) goto L_0x00d5;
    L_0x00ba:
        r2 = r10;
        r17 = "MRaid";
        r18 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        r18.<init>();	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        r19 = "MMJS BuildDate:";
        r18 = r18.append(r19);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        r0 = r18;
        r18 = r0.append(r2);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        r18 = r18.toString();	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        com.millennialmedia.android.MMLog.d(r17, r18);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
    L_0x00d5:
        r17 = "* Version";
        r0 = r17;
        r17 = r10.contains(r0);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
    ...
    L_0x00df:
        r17 = android.text.TextUtils.isEmpty(r16);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        if (r17 == 0) goto L_0x0103;
    L_0x00e5:
        r16 = r10;
        r17 = "MRaid";
        ...
        r0 = r18;
        r1 = r16;
        r18 = r0.append(r1);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        r18 = r18.toString();	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
        com.millennialmedia.android.MMLog.d(r17, r18);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
    L_0x0103:
        r17 = android.text.TextUtils.isEmpty(r16);	 Catch:{ Exception -> 0x01a0, all -> 0x0198 }
    ...
    L_0x0114:
        r17 = "MRaid";
        r18 = "MMJS stats exception: ";
        r0 = r17;
        r1 = r18;
        com.millennialmedia.android.MMLog.e(r0, r1, r5);	 Catch:{ all -> 0x013a }
        r3 = 0;
    ...
    L_0x0127:
        r14.close();	 Catch:{ Exception -> 0x012c }
        goto L_0x0063;
    L_0x012c:
        r5 = move-exception;
        r17 = "MRaid";
        r18 = "Exception closing file: ";
        r0 = r17;
        r1 = r18;
        com.millennialmedia.android.MMLog.e(r0, r1, r5);
        goto L_0x0063;
    L_0x013a:
        r17 = move-exception;
    L_0x013b:
    ...
    L_0x0142:
        r14.close();	 Catch:{ Exception -> 0x017a }
    L_0x0145:
        throw r17;
    L_0x0146:
        r17 = "MMJS Stats: Version[%s] buildDate[%s] MD5[%s] dlDate[%s] Size[%d] Url[%s]";
        r18 = 6;
        r0 = r18;
        r0 = new java.lang.Object[r0];
        r18 = r0;
    ...
    L_0x01a0:
        ...
        goto L_0x0114;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.millennialmedia.android.MRaid.getMMJSStats(android.content.Context):java.lang.String");
    }

    static boolean saveMRaid(Context context, InputStream is) {
        Exception e;
        Throwable th;
        File mraidJsFile = new File(AdCache.getInternalCacheDirectory(context), MRAID_JS_FILE_NAME);
        MMLog.v(TAG, String.format("Saving mraid js to %s", new Object[]{mraidJsFile}));
        FileOutputStream out = null;
        try {
            FileOutputStream out2 = new FileOutputStream(mraidJsFile);
            try {
                    ...
                    if (numread <= 0) {
                        if (out2 != null) {
                            try {
                                ...
                                MMLog.e(TAG, "Exception closing file: ", e2);
                            }
                        }
                        out = out2;
                        return true;
                ...
                try {
                    ...
                    if (out != null) {
                        try {
                            ...
                            MMLog.e(TAG, "Exception closing file: ", e22);
                        }
                    }
                    throw th;
                }
            }
            MMLog.e(TAG, "Exception downloading component mraid.js: ", e);
            if (out != null) {
                try {
                    out.close();
                } catch (IOException e222) {
                    MMLog.e(TAG, "Exception closing file: ", e222);
                }
            }
            return false;
        }
    ...
    static boolean isMRaidUpdated(Context context, String mmjsUrl) {
        ...
        if (!hasMraidLocally && ORIGINAL_MMJS_URL.equals(mmjsUrl)) {
            if (saveIncludedMMJS(context, mmjsUrl)) {
                MMLog.i(TAG, "Using bundled version of mm.js");
                return true;
            }
            MMLog.e(TAG, "Unable to save bundled version of mm.js");
        }
        String previousUrl = getPreviousUrl(context);
        MMLog.d(TAG, "Previous mm.js url is <" + previousUrl + ">");
        if (hasMraidLocally && mmjsUrl.equals(previousUrl)) {
            return true;
        }
        return false;
    }
    ...
    static boolean hasMraidLocally(Context context) {
        ...
        if (mmjs != null) {
            MMLog.d(TAG, "@@-MMJS File location: " + mmjs.getAbsolutePath());
        }
        return mmjs != null && mmjs.exists();
    }

    static boolean saveIncludedMMJS(Context context, String mmjsUrl) {
        byte[] mmjsBytesFirst = Base64.decode(MMJS_1_7_PART1);
        byte[] mmjsBytesSecond = Base64.decode(MMJS_1_7_PART2);
