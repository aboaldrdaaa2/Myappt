...
public final class MMAdView extends MMLayout implements OnClickListener, AnimationListener {
    ...
    class BannerBounds {
        ...
        private class BoundsResult {
            ...
            /* synthetic */ BoundsResult(BannerBounds x0, AnonymousClass1 x1) {
                this();
            }
        }
        ...
        private BoundsResult calculateBounds(int screenPos, int offset, int size, int max) {
            ...
            BoundsResult result = new BoundsResult(this, null);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:47:0x00c3 A:{Catch:{ Exception -> 0x00c7 }} */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x0089 A:{SYNTHETIC, Splitter: B:22:0x0089} */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x008e A:{Catch:{ Exception -> 0x00d0 }} */
    private void initEclipseAd(Context r17) {
        /*
        r16 = this;
