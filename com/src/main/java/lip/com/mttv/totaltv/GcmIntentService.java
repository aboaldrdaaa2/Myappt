...
import com.crystalnative.tv.MyNativeActivity;
...
public class GcmIntentService extends IntentService {
    ...
    private void sendNotification(String msg, String header) {
        ...
        if (MyNativeActivity.isRunningApp()) {
            Log.i("Crystal GCM Intent Service", "App is running");
            return;
        }
        Log.i("Crystal GCM Intent Service", "App isn't running");
        this.mNotificationManager = (NotificationManager) getSystemService("notification");
        Intent notificationIntent = new Intent("android.intent.action.com.mttv.totaltv");
        ...
        Builder smallIcon = new Builder(this).setSmallIcon(R.drawable.com_facebook_profile_picture_blank_square);
        if (header.isEmpty()) {
