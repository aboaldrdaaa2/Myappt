...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
    ...
    private class SearchTextWatcher implements TextWatcher {
        ...
        /* synthetic */ SearchTextWatcher(PlacePickerFragment x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class AsNeededLoadingStrategy extends LoadingStrategy {
        ...
        /* synthetic */ AsNeededLoadingStrategy(PlacePickerFragment x0, AnonymousClass1 x1) {
            this();
        }

        public void attach(GraphObjectAdapter<GraphPlace> adapter) {
            super.attach(adapter);
            this.adapter.setDataNeededListener(new DataNeededListener() {
