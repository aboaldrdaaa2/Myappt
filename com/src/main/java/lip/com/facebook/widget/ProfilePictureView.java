...
public class ProfilePictureView extends FrameLayout {
    ...
    private void sendImageRequest(boolean allowCachedResponse) {
        try {
            ImageRequest request = new Builder(getContext(), ImageRequest.getProfilePictureUrl(this.profileId, this.queryWidth, this.queryHeight)).setAllowCachedRedirects(allowCachedResponse).setCallerTag(this).setCallback(new Callback() {
