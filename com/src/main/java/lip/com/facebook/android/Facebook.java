...
public class Facebook {
        ...
        public void handleMessage(Message msg) {
            ...
            if (facebook != null && connection != null) {
                ...
                if (token != null) {
                    ...
                    String error = msg.getData().getString(NativeProtocol.BRIDGE_ARG_ERROR_BUNDLE);
                    if (msg.getData().containsKey("error_code")) {
                        connection.serviceListener.onFacebookError(new FacebookError(error, null, msg.getData().getInt("error_code")));
                    } else {
    ...
    private class SetterTokenCachingStrategy extends TokenCachingStrategy {
        ...
        /* synthetic */ SetterTokenCachingStrategy(Facebook x0, AnonymousClass1 x1) {
            this();
        }
    ...
    /* JADX WARNING: Missing block: B:46:0x0094, code:
            r7 = false;
     */
    /* JADX WARNING: Missing block: B:57:0x0090, code:
            continue;
     */
