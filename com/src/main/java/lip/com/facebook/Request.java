...
public class Request {
    ...
    private static class Serializer implements KeyValueSerializer {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:26:0x0082  */
        /* JADX WARNING: Removed duplicated region for block: B:28:0x0087  */
        public void writeFile(String r15, ParcelFileDescriptor r16, String r17) throws IOException {
            /*
            r14 = this;
        ...
        L_0x0004:
            r0 = r17;
            r14.writeContentDisposition(r15, r15, r0);
            r7 = 0;
            r8 = r14.outputStream;
            r8 = r8 instanceof com.facebook.ProgressNoopOutputStream;
            if (r8 == 0) goto L_0x0053;
        L_0x0010:
            r8 = r14.outputStream;
            r8 = (com.facebook.ProgressNoopOutputStream) r8;
            r9 = r16.getStatSize();
            r8.addProgress(r9);
        L_0x001b:
            r8 = "";
        ...
        L_0x002a:
            ...
            r8.appendKeyValue(r9, r10);
        L_0x0052:
            return;
        L_0x0053:
            r5 = 0;
            r2 = 0;
            r6 = new android.os.ParcelFileDescriptor$AutoCloseInputStream;	 Catch:{ all -> 0x007f }
            r0 = r16;
            r6.<init>(r0);	 Catch:{ all -> 0x007f }
            r3 = new java.io.BufferedInputStream;	 Catch:{ all -> 0x008b }
            r3.<init>(r6);	 Catch:{ all -> 0x008b }
            r8 = 8192; // 0x2000 float:1.14794E-41 double:4.0474E-320;
            r1 = new byte[r8];	 Catch:{ all -> 0x008e }
        L_0x0065:
            r4 = r3.read(r1);	 Catch:{ all -> 0x008e }
            r8 = -1;
            if (r4 == r8) goto L_0x0074;
        L_0x006c:
            r8 = r14.outputStream;	 Catch:{ all -> 0x008e }
            r9 = 0;
            r8.write(r1, r9, r4);	 Catch:{ all -> 0x008e }
            r7 = r7 + r4;
            goto L_0x0065;
        L_0x0074:
