...
public class Session implements Serializable {
    ...
    public static class AuthorizationRequest implements Serializable {
        ...
        private static class AuthRequestSerializationProxyV1 implements Serializable {
            ...
            /* synthetic */ AuthRequestSerializationProxyV1(SessionLoginBehavior x0, int x1, List x2, String x3, boolean x4, String x5, String x6, AnonymousClass1 x7) {
        ...
        /* synthetic */ AuthorizationRequest(SessionLoginBehavior x0, int x1, List x2, String x3, boolean x4, String x5, String x6, AnonymousClass1 x7) {
            this(x0, x1, x2, x3, x4, x5, x6);
        }
        ...
        AuthorizationRequest getAuthorizationClientRequest() {
            return new AuthorizationRequest(this.loginBehavior, this.requestCode, this.isLegacy, this.permissions, this.defaultAudience, this.applicationId, this.validateSameFbidAsToken, new StartActivityDelegate() {
                public void startActivityForResult(Intent intent, int requestCode) {
    ...
    /* synthetic */ Session(String x0, SessionState x1, AccessToken x2, Date x3, boolean x4, AuthorizationRequest x5, Set x6, AnonymousClass1 x7) {
        this(x0, x1, x2, x3, x4, x5, x6);
    }
    ...
    /* JADX WARNING: Missing block: B:16:?, code:
            return;
     */
    void extendTokenCompleted(Bundle r6) {
        /*
        r5 = this;
        r2 = r5.lock;
        monitor-enter(r2);
        r0 = r5.state;	 Catch:{ all -> 0x0051 }
        r1 = com.facebook.Session.AnonymousClass5.$SwitchMap$com$facebook$SessionState;	 Catch:{ all -> 0x0051 }
    ...
    L_0x001d:
        ...
        r2 = com.facebook.Session.AnonymousClass5.$SwitchMap$com$facebook$SessionState;	 Catch:{ all -> 0x0034 }
        r4 = r7.state;	 Catch:{ all -> 0x0034 }
