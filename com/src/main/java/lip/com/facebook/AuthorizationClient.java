...
class AuthorizationClient implements Serializable {
    ...
    class WebViewAuthHandler extends AuthHandler {
        ...
        private void saveCookieToken(String token) {
            Editor editor = AuthorizationClient.this.getStartActivityDelegate().getActivityContext().getSharedPreferences(AuthorizationClient.WEB_VIEW_AUTH_HANDLER_STORE, 0).edit();
    ...
    class KatanaProxyAuthHandler extends KatanaAuthHandler {
        ...
        boolean onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (data == null) {
                ...
                outcome = Result.createCancelResult(AuthorizationClient.this.pendingRequest, data.getStringExtra(NativeProtocol.BRIDGE_ARG_ERROR_BUNDLE));
    ...
    StartActivityDelegate getStartActivityDelegate() {
        ...
        return this.pendingRequest != null ? new StartActivityDelegate() {
            public void startActivityForResult(Intent intent, int requestCode) {
